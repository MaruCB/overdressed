...
Costume.create(name: "Car", price: "45", description: "Vroum vroum", size: "L", category: "Folk", photo_url: "https://i.ebayimg.com/images/g/Lc8AAOSwLxZiQ07O/s-l300.jpg", user_id:1)
Costume.create(name: "Lama", price: "29", description: "It's a lama", size: "L", category: "Animals", photo_url: "https://images.fun.co.uk/products/41458/2-1-106511/llama-adult-costume.jpg", user_id:1)
Costume.create(name: "Vampire", price: "75", description: "Edward Cullen's cousin", size: "L", category: "Folk", photo_url: "https://cdn.shopify.com/s/files/1/0023/6178/6426/products/fever-male-vampire-costume.jpg?v=1603019908", user_id:1)
...
Costume.create(name: "Avatar", price: "90", description: "James Cameron's son", size: "L", category: "Fantasy", photo_url: "https://cdn.shopify.com/s/files/1/0276/9308/8803/products/Deluxe_Jake_Sully_Costume_1200x1200.jpg?v=1575226311", user_id:1)
Costume.create(name: "Gatsby", price: "140", description: "Back to 1922", size: "L", category: "Fancy", photo_url: "https://cdn.shopify.com/s/files/1/0023/6178/6426/products/flapper-costume-black-with-long-dress_900x.jpg?v=1603010553", user_id:1)
Costume.create(name: "Fairy", price: "48", description: "Tinker Bell's property. Please return", size: "L", category: "Folk", photo_url: "https://images.halloweencostumes.co.uk/products/63738/1-1/mens-forest-fairy-costume.jpg", user_id:1)
Costume.create(name: "Mother Nature", price: "65", description: "Because our planet matters", size: "L", category: "Fantasy", photo_url: "https://www.seekpng.com/png/detail/415-4159040_mother-nature-mother-nature-costume.png", user_id:1)
Costume.create(name: "Tomato", price: "29", description: "Your daily portion of fruits", size: "L", category: "Party", photo_url: "https://images.halloweencostumes.co.uk/products/67323/1-1/adult-inflatable-tomato-costume.jpg", user_id:1)
